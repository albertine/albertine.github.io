...
if(!isset($_POST['email'])) {
  ...
  $email_to1 = "dubois@imnc.in2p3.fr";
  $email_to2 = "albertine.dubois@gmail.com";
  $from_name = "albertine.dubois";
  $from_mail = "dubois@imnc.in2p3.fr";
  
  $email_subject = "Gate logo contest: Submission";
